...
type Client struct {
	...
	// AppName is the name of the application using the auroraclient package
	AppName string
...
// LedgerRequest struct contains data for getting ledger details from a aurora server.
// The query parameters (Order, Cursor and Limit) are optional. All or none can be set.
...
// OperationRequest struct contains data for getting operation details from a aurora server.
...
// See https://www.diamnet.org/developers/aurora/reference/endpoints/path-finding-strict-receive.html
...
// See https://www.diamnet.org/developers/aurora/reference/endpoints/path-finding-strict-send.html
...
// TradeAggregationRequest struct contains data for getting trade aggregations from a aurora server.
