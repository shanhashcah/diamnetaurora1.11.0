...
func (r *RevokeSponsorship) Validate() error {
	...
	case RevokeSponsorshipTypeAccount:
		...
		return validateDiamnetPublicKey(*r.Account)
	case RevokeSponsorshipTypeTrustLine:
		if r.TrustLine == nil {
			return errors.New("Trustline can't be nil")
		}
		if err := validateDiamnetPublicKey(r.TrustLine.Account); err != nil {
			return errors.Wrap(err, "invalid Account address")
		}
		if err := validateDiamnetAsset(r.TrustLine.Asset); err != nil {
	...
	case RevokeSponsorshipTypeOffer:
		...
		if err := validateDiamnetPublicKey(r.Offer.SellerAccountAddress); err != nil {
			return errors.Wrap(err, "invalid Seller account address")
		}
		return validateDiamnetPublicKey(r.Offer.SellerAccountAddress)
	case RevokeSponsorshipTypeData:
		if r.Data == nil {
			return errors.New("Data can't be nil")
		}
		if err := validateDiamnetPublicKey(r.Data.Account); err != nil {
			return errors.Wrap(err, "invalid Account address")
		}
	case RevokeSponsorshipTypeClaimableBalance:
		if r.ClaimableBalance == nil {
	...
	case RevokeSponsorshipTypeSigner:
		...
		if err := validateDiamnetPublicKey(r.Signer.AccountID); err != nil {
			return errors.New("invalid Account address")
		}
		if err := validateDiamnetSignerKey(r.Signer.SignerAddress); err != nil {
