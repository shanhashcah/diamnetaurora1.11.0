...
import (
	...
	"github.com/diamnet/go/exp/services/webauth/internal/serve"
...
func (c *ServeCommand) Command() *cobra.Command {
	...
	configOpts := config.ConfigOptions{
		...
		{
			Name:      "signing-key",
			Usage:     "Diamnet signing key(s) used for signing transactions comma separated (first key is used for signing, others used for verifying challenges)",
			OptType:   types.String,
