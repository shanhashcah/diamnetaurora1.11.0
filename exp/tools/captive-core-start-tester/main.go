...
// This little app helped testing CaptiveDiamnetCore.runFromParams on a living
// Diamnet-Core. Adding it to the repo because it can be useful in a future if
// Diamnet-Core behaviour changes again.
