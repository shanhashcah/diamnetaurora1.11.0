# Get state from diamnet-core DB, colums match CSV printer
...
echo "Fetching accounts from diamnet-core DB..."
...
echo "Fetching accountdata from diamnet-core DB..."
...
echo "Fetching offers from diamnet-core DB..."
...
echo "Fetching trustlines from diamnet-core DB..."
