...
func (u DiamnetValueExt) ArmForSwitch(sw int32) (string, bool) {
	switch DiamnetValueType(sw) {
	case DiamnetValueTypeDiamnetValueBasic:
		return "", true
	case DiamnetValueTypeDiamnetValueSigned:
...
func NewDiamnetValueExt(v DiamnetValueType, value interface{}) (result DiamnetValueExt, err error) {
	result.V = v
	switch DiamnetValueType(v) {
	case DiamnetValueTypeDiamnetValueBasic:
		// void
	case DiamnetValueTypeDiamnetValueSigned:
...
// panicing if the value is not set.
func (u DiamnetMessage) MustSignedSurveyRequestMessage() SignedSurveyRequestMessage {
...
// returning ok if the union's switch indicated the value is valid.
func (u DiamnetMessage) GetSignedSurveyRequestMessage() (result SignedSurveyRequestMessage, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u DiamnetMessage) MustSignedSurveyResponseMessage() SignedSurveyResponseMessage {
...
// returning ok if the union's switch indicated the value is valid.
func (u DiamnetMessage) GetSignedSurveyResponseMessage() (result SignedSurveyResponseMessage, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
