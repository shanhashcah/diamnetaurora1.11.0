...
type Minion struct {
	...
	// Mockable functions
	SubmitTransaction    func(minion *Minion, hclient *auroraclient.Client, tx string) (*hProtocol.Transaction, error)
	CheckSequenceRefresh func(minion *Minion, hclient *auroraclient.Client) error
...
func SubmitTransaction(minion *Minion, hclient *auroraclient.Client, tx string) (*hProtocol.Transaction, error) {
...
func CheckSequenceRefresh(minion *Minion, hclient *auroraclient.Client) error {
