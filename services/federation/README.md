...
[Prebuilt binaries](https://github.com/diamnet/go/releases) of the federation server are available on the [releases page](https://github.com/diamnet/go/releases).
...
```
go get -u github.com/diamnet/go/services/federation
```
