# `diamnet/expingest-verify-range`

This docker image allows running multiple instances of `aurora expingest verify-command` on a single machine or running it in [AWS Batch](https://aws.amazon.com/batch/).
