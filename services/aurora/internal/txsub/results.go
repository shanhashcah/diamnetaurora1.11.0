...
func txResultByHash(db AuroraDB, hash string) (history.Transaction, error) {
...
// is ingested.
func checkTxAlreadyExists(db AuroraDB, hash, sourceAddress string) (history.Transaction, uint64, error) {
