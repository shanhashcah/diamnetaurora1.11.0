...
func TestNewSystem(t *testing.T) {
	config := Config{
		...
		HistoryArchiveURL:        "https://history.diamnet.org/prd/core-live/core_live_001",
	}
...
type mockDiamnetCoreClient struct {
	mock.Mock
}

func (m *mockDiamnetCoreClient) SetCursor(ctx context.Context, id string, cursor int32) error {
	args := m.Called(ctx, id, cursor)
	return args.Error(0)
}

var _ diamnetCoreClient = (*mockDiamnetCoreClient)(nil)
