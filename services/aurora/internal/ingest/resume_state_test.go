...
type ResumeTestTestSuite struct {
	...
	diamnetCoreClient *mockDiamnetCoreClient
	system            *system
}
...
func (s *ResumeTestTestSuite) SetupTest() {
	...
	s.diamnetCoreClient = &mockDiamnetCoreClient{}
	s.system = &system{
		...
		diamnetCoreClient: s.diamnetCoreClient,
	}
...
func (s *ResumeTestTestSuite) TearDownTest() {
	...
	s.diamnetCoreClient.AssertExpectations(t)
}
