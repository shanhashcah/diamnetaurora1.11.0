...
import (
	...
	"github.com/diamnet/go/services/aurora/internal/context"
...
func (handler GetTradeAggregationsHandler) GetResource(w HeaderWriter, r *http.Request) (interface{}, error) {
	...
	aggregations := []aurora.TradeAggregation{}
	for _, record := range records {
		var res aurora.TradeAggregation
...
func (handler GetTradeAggregationsHandler) buildPage(r *http.Request, records []aurora.TradeAggregation) (hal.Page, error) {
	ctx := r.Context()
