...
func pageableToOffers(t *testing.T, page []hal.Pageable) []aurora.Offer {
	var offers []aurora.Offer
	for _, entry := range page {
		offers = append(offers, entry.(aurora.Offer))
	}
	return offers
}
